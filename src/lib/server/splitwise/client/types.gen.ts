...
export type ClientOptions = {
    baseUrl: 'https://secure.splitwise.com/api/v3.0' | (string & {});
};

export type Debt = Debt2;

export type User = User2;

export type CurrentUser = CurrentUser2;

export type NotificationSettings = NotificationSettings2;

export type Group = Group2;
 ...
 */
export type NotificationSettings2 = {
    [key: string]: boolean;
};

export type CurrentUser2 = User2 & {
    /**
...
export type Group2 = {
    ...
    original_debts?: Array<Debt2>;
    simplified_debts?: Array<Debt2>;
    avatar?: {
